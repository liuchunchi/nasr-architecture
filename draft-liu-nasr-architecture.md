...
The orchestrator/controller may include two functions, one is orchestrator and the other is the controller.  The orchestrator/controller obtains informations and output path and security configurations, then distribute to the attester/device by NETCONF which need to define a new YANG module.
